...
wbp <- . %>% wastdr::wastd_bulk_post("occ-observation", verbose = T)
...
tfa_phys_sample_res <- tfa_phys_sample %>% wbp
tfa_anim_obs_res <- tfa_anim_obs %>% wbp
tfa_ass_species_res <- tfa_ass_species %>% wbp
tfa_veg_class_res <- tfa_veg_class %>% wbp
tfa_hab_comp_res <- tfa_hab_comp %>% wbp
```
