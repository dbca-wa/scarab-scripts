...
bv btfa_anim_obs_res <- tfa_anim_obs_complete %>% 
...
Below are "spot-check" results for the migrated occurrence observations data. 
Each table shows example records for three species.
Any differences would mean the data had not been migrated correctly. 
...
tsc_species_anim_obs <- tsc_fauna_observations %>% 
  ...
  select(c("source_id","tsc_detection_method","tsc_no_adult_male")) 
