...
readr::write_csv(tfa_species_notes_duplications, path = here::here("data", "tfa_species_notes_duplications.csv"))
...
tfa_anim_obs <- tfa_anim_obs %>% 
  dplyr::filter(!source_id %in% c(140172,140215))
tfa_veg_class <- tfa_veg_class %>% 
  dplyr::filter(!source_id %in% c(140172,140215))
tfa_hab_comp <- tfa_hab_comp %>%
  dplyr::filter(!source_id %in% c(140215))
