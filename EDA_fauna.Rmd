...
There are `r nrow(missing_occurrences)` occurrences missing from tsc when compared to tfa_tae The occurrences listed were likely not migrated because ????????
