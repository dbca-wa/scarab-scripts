...
tfa_listing_cat_iucn2012_res <- tfa_listing_cat_iucn2012 %>% 
  chunk_post("taxon-conservationlisting")
...
tfa_tae_res <- tfa_tae[70000:107965,] %>% 
  chunk_post(serializer = "occ-taxon-points", chunksize = 1000)
...
tfa_phys_sample_res <- tfa_phys_sample_complete %>% 
  wastd_occ_obs_post(obstype="PhysicalSample", chunksize = 1000) 

tfa_anim_obs_res <- tfa_anim_obs_complete %>% 
  wastd_occ_obs_post(obstype="AnimalObservation", chunksize = 1000)
...
tfa_veg_class_res <- tfa_veg_class_complete %>% 
  wastd_occ_obs_post(obstype="VegetationClassification", chunksize = 1000)
