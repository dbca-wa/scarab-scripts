...
tfa_tae <- tfa_occ %>%
  ...
  dplyr::transmute(
    ...
    description = glue::glue(
        ...
        "Associated species: {associated_flora_species_1} {associated_flora_species_2} {associated_flora_species_3} {associated_flora_species_4} {associated_flora_species_5} {associated_flora_species_6}\n"),
    source = 10,
    source_id = id,
