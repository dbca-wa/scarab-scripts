...
tfa_tae %>% chunk_post(serializer = "occ-taxon-points", verbose = T, api_url = prod)
```
...
```{r, eval=FALSE}
tfa_phys_sample[1,] %>% wastd_bulk_post("occ-observation", verbose = TRUE)

tfa_phys_sample %>% wastd_bulk_post("occ-observation")
...
datafile.tsc.fauna <- here::here("data/fauna_tsc.RData")
