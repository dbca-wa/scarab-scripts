...
# missing_taxa_occ <- tfa_tae %>% 
#     dplyr::anti_join(tsc_occ_fauna, by = "taxon") - this wont work because of geometry
...
unique(tsc_tae$source_id) #93972
setdiff(tfa_tae$source_id,tsc_occ_fauna$source_id) # 39070 source_id's in tfa that are not in tsc

```

There are `r nrow(missing_tae_tsc)` occurrences missing from tsc_tae when compared to tfa_tae. These missing occurrences come from `r nrow(missing_taxa_tsc_unique)` 26 unique species.
