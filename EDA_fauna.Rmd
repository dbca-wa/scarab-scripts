...
leaflet::leaflet(width = 800, height = 600) %>%
  ...
  leaflet::addAwesomeMarkers(
    ...
    label = ~ glue::glue("{datetime} {name_id} {location_id} ({location_name})"),
    # popup = ~ glue::glue(
...
tfa_tae[100001:106201,] %>% chunk_post(serializer = "occ-taxon-points", chunksize = 100)
...
if (file.exists(tsc_occ_fauna_datafile)) {
  ...
  # nrow(tsc_tae) 150987 - all fauna taxa occurrences in TSC
  # nrow(tsc_occ_fauna) 106177 - all fauna taxa occurrences joined to tsc_taxa_fauna
  # this is puzzling
