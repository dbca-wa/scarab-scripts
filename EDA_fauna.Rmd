...
readr::write_csv(path = here::here("data", "missing_tae_anim_obs.csv"))
missing_tae_veg_class <- tfa_veg_class %>% 
  dplyr::anti_join(tfa_tae, by = "source_id") %>% #2 source_id = 140172, 140215
readr::write_csv(path = here::here("data", "missing_tae_veg_class.csv"))
missing_tae_hab_comp <- tfa_hab_comp %>% 
  dplyr::anti_join(tfa_tae, by = "source_id") %>% #1 source_id = 140215
readr::write_csv(path = here::here("data", "missing_tae_hab_comp.csv"))
