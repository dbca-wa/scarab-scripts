...
tfa_habitat <- tfa_occ %>% 
  select(c(id,landform_id, vegetation_type_id,VegCode,VegTypeName,vegetation_type)) %>% 
  dplyr::rename(source_id = id) %>% distinct()

unique(tfa_habitat$landform_id)
unique(tfa_habitat$vegetation_type_id)
...
tfa_tae <- tfa_occ %>%
  ...
  dplyr::transmute(
    ...
    associated_species = glue::glue("{associated_flora_species_1} {associated_flora_species_2} {associated_flora_species_3} {associated_flora_species_4} {associated_flora_species_5} {associated_flora_species_6}"),
