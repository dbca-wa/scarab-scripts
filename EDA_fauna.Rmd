...
datafile_tsc <- here::here("data", "etl_fauna_tsc.Rda")
...
if (file.exists(datafile_tsc)) {fs::file_delete(datafile_tsc)}
```
...
if (file.exists(datafile_tsc)) {
  ...
  save(tsc_taxa_fauna, tsc_tcl_fauna, file = datafile_tsc)
}
```
