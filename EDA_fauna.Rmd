...
unique(tsc_occ_fauna$taxon) #3655
intersect(tsc_occ_fauna$taxon,tfa_tae$taxon) # 892 similar
setdiff(tsc_occ_fauna$taxon,tfa_tae$taxon) # 2758 taxon in tsc that are not in tfa
