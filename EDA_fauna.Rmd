...
tsc_phys_sample_sum <-
  tsc_tae_observations_fauna %>% make_tsc_occ_obs_summary("PhysicalSample")
tsc_anim_obs_sum <-
  tsc_tae_observations_fauna %>% make_tsc_occ_obs_summary("AnimalObservation")
tsc_veg_class_sum <-
  tsc_tae_observations_fauna %>% make_tsc_occ_obs_summary("VegetationClassification")
tsc_hab_comp_sum <-
  tsc_tae_observations_fauna %>% make_tsc_occ_obs_summary("HabitatComposition")
