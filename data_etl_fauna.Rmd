...
tfa_listing_cat_iucn %>% wastdr::wastd_POST("taxongazettal", api_url = prod)
...
tfa_listing_cat_wawca %>% wastdr::wastd_POST("taxongazettal", api_url = prod)
...
tfa_listing_cat_spfn %>% wastdr::wastd_POST("taxongazettal", api_url = prod)
...
tfa_listing_cat_waps %>% wastdr::wastd_POST("taxongazettal", api_url = prod)
...
tfa_listing_cat_epbc %>% wastdr::wastd_POST("taxongazettal", api_url = prod)
