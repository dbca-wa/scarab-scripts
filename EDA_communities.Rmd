...
tsc_ccl_community_datafile <- here::here("data/tsc_ccl_community.RData")
...
save(tec, snapshot_last_updated, file=tec_file)
}
...
```{r get_tsc_ccl2}
if (file.exists(tsc_ccl_community_datafile)) {
  load(tsc_ccl_community_datafile)
} else {
...
save(tsc_ccl_communities, file = tsc_ccl_community_datafile, compress="xz")
}
```
...
tsc_cae_data <- wastdr::wastd_GET("occ-community-points",chunk_size = 100) # k records
