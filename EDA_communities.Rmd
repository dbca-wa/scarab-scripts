...
tsc_community_boundaries <- tsc_cae_data %>%
 ...
 # Community occurrence observations
  ...
  tsc_communities_observations <- tsc_tae_observations %>% 
...
# site_cae_create_res <- site_cae_create %>% chunk_post(serializer = "occ-community-points", chunksize = 100)
# bdy_cae_create_res <- bdy_cae_create %>% chunk_post(serializer = "occ-community-points", chunksize = 100)
```
