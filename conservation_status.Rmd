...
* With BCA going into effect ca Sep 2018, new TEC nomionations will use IUCN RLE categories and criteria. Existing cat (and possibly crit) will be rolled over into BCA and replaced by RLE over time.
...
* ActionPlan gazettals are read by an officer (offline and outside TSC), who then may choose to create
  a WAGazettal.
