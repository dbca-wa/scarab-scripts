...
fauna_tae %>% chunk_post(serializer = "occ-taxon-points", api_url = dev)
```
## Flora
...
flora_tae %>% chunk_post(serializer = "occ-taxon-points", api_url = dev)
```
...
tec_cae %>% chunk_post(serializer = "occ-community-areas", api_url = dev)
```
