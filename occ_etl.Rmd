...
save(taxa, fauna_occ, fauna_tae, file=occ_file)
if (file.exists(occ_file)) load(occ_file)

fauna_tae[10001:43558,] %>% chunk_post(serializer = "occ-taxon-points", verbose = T, api_url = prod)
```
...
flora_tae %>% chunk_post(serializer = "occ-taxon-points", verbose = T, api_url = dev)
```
