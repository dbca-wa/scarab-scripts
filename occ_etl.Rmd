...
```{r}
eoo_polygon <- function(data, name_id=NULL, crs=4283){
    data %>% 
        dplyr::filter(name_id == name_id) %>%
        # TODO filter to last 10 years
...
eoo_24557 <- eoo_polygon(fauna_occ, name_id = 24557)
...
eoo_24734 <- eoo_polygon(fauna_occ, name_id = 24734)
# mapview(eoo_24734)
