...
tec <- geojsonsf::geojson_sf("data/tec_boundaries.geojson")
tec_cae <- tibble::tibble(
    community = tec$COM_ID,
    name=tec$BDY_ID,
    description = glue::glue(""),
    area_type = 10, # 10 bound, 11 buffer, 12 site point
    source = 12, # TEC
    source_id = tec$OCC_UNIQUE,
...
tec_cae %>% wastdr::wastd_POST("occ-community-areas", verbose=T, api_url = dev)
```
