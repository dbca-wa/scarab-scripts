...
tfl_cl_datafile <- here::here("data", "tfl_cons_listings.Rdata")
save(tfl_cons_listing, file=tfl_cl_datafile)
if (file.exists(tfl_cl_datafile)) load(tfl_cl_datafile)
...
tfl_tae_create <- tfl_tae %>% 
  dplyr::anti_join(tsc_occ_flora, by = "source_id") #2448 # 2211 # 2293

tfl_tae_update <- tfl_tae %>% 
  dplyr::semi_join(tsc_occ_flora, by = "source_id") #42343 # 42580 # 42498
