...
`r nrow(missing_occ_tfl_tae_unique)` unique species. The occurrences listed were likely not migrated because
they do not contain a name_id and/or a location which are a requirement of a tfa taxon area encounter.
