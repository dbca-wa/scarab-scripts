...
tfl_listing_cat_priority_res <- tfl_listing_cat_priority %>% 
  chunk_post("taxon-conservationlisting", chunksize = 100, verbose = TRUE)
tfl_listing_cat_epbc_res <- tfl_listing_cat_epbc %>% 
  wastdr::wastd_POST("taxon-conservationlisting", verbose = TRUE)
...
tfl_plant_count_res <- tfl_plant_count[1,] %>%
  wastd_occ_obs_post(obstype="PlantCount", api_url = uat)
...
tfl_area_ass_res <- tfl_area_ass %>%
  wastd_occ_obs_post(obstype="AreaAssessment", chunksize = 1000) #9899
tfl_plant_count_res <- tfl_plant_count[1:1000,] %>%
  wastd_occ_obs_post(obstype="PlantCount", api_url = uat, chunksize = 1000) #38624
