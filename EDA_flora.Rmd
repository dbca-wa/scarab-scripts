...
tfl_plant_count_res <- tfl_plant_count[1:2,] %>%
...
tfl_tae_create <- tfl_tae %>% 
  dplyr::anti_join(tsc_occ_flora, by = "source_id") #2012

setdiff(tfl_tae$source_id,tsc_occ_flora$source_id) #2012
setdiff(tsc_occ_flora$source_id,tfl_tae$source_id) #0

occ_flora_dup <- tsc_occ_flora %>%filter(duplicated(.[["source_id"]])) #2010
