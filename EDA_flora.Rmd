...
# FM laptop, R 3.6.3, dplyr 1.0.0: 106 152 TFA + 44 835 TFL = 150 987 TSC TAE
# FM RSS,    R 4.0.0, dplyr 0.8.5: 106 120 TFA + 44 867 TFL = 150 987 TSC TAE
# FM RSS,    R 4.0.0, dplyr 0.8.5: 106 156 TFA + 44 831 TFL = 150 987 TSC TAE
tsc_tae %>% dplyr::filter(source == 10) %>% nrow
tsc_tae %>% dplyr::filter(source == 11) %>% nrow

# All sources are flora (11): inner_join to tsc_taxa_flora seems to work
unique(tsc_occ_flora$source)
# However, different number of unique source IDs
# FM laptop, R 3.6.3, dplyr 1.0.0: 43 050 on Fri 22 May
# FM laptop, R 3.6.3, dplyr 1.0.0: 42 206 on Mon 08 Jun
# FM RSS,    R 4.0.0, dplyr 0.8.5: 42 887 on Mon 08 Jun
