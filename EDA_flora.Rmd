...
y <- unique(tfl_plant_count$source_id)
...
Soil type: Three of these criteria could not be mapped because we don't know
what they are.
...
The above need to be approved before the manual mapping can be considered complete.
...
tsc_hab_cond_sum <-
  tsc_tae_observations %>% make_tsc_occ_obs_summary("HabitatCondition")
tsc_area_ass_sum <-
  tsc_tae_observations %>% make_tsc_occ_obs_summary("AreaAssessment")
tsc_hab_comp_sum <-
  tsc_tae_observations %>% make_tsc_occ_obs_summary("HabitatComposition")
# tsc_plant_count_sum <- 
#   tsc_tae_observations %>% make_tsc_cl_summary("PlantCount")
