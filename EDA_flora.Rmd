...
if (file.exists(tsc_occ_flora_datafile)) {
  ...
  tsc_tae_data <- wastdr::wastd_GET("occ-taxon-points") # 150 987
...
tsc_tae3 %>% dplyr::filter(source == 10) %>% nrow
tsc_tae3 %>% dplyr::filter(source == 11) %>% nrow # == tsc_occ_flora
...
dplyr::all_equal(tsc_tae2, tsc_tae3)
