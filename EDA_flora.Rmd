...
# LONG RUNNING UPLOAD
tfl_tae_res <- tfl_tae[44001:44791,] %>% 
  chunk_post(serializer = "occ-taxon-points", chunksize = 1000) #44791
```
...
if (file.exists(tsc_occ_flora_datafile)) {
  ...
  tsc_tae_data <- wastdr::wastd_GET("occ-taxon-points", query = list(source=11)) # Should be 44791 tfl_tae + 106... tfa_tae
  ...
  tsc_occ_flora <- tsc_tae %>%
    ...
    dplyr::filter(source == 11) # Should be 44791 tfl_tae
