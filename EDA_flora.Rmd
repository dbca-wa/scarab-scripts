...
tfl_tae %>% chunk_post(serializer = "occ-taxon-points", verbose = T, api_url = prod) # upload for all occurances
```
...
tae_tally_btm <- tae_tally %>% 
  top_n(20,-n) %>% 
  slice(1:20) # There are actually 301 species with an occurance of 1
