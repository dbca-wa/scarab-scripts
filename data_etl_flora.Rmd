...
all_crit_map <- flora_cons_listing %>%
  ...
  dplyr::arrange(list_code, criteria_code_wa) %>% 
  dplyr::select(list_code, criteria_code_wa)
...
upload_to_ckan(flora_cl, "TPFL Conservation Listings", 
